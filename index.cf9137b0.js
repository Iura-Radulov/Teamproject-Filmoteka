 ...
 * limitations under the License.
 */
function Jl(e=nt()){const t=Ze(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ze(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(oe(n.getOptions(),null!=t?t:{}))return e;xs(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Kl,persistence:[dl,Qa,Za]})}function Zl(){N.txtEmailLogin.value="",N.txtPasswordLogin.value="",N.txtEmailRegister.value="",N.txtPasswordRegister.value=""}function ec(){N.formLogin.style.display="flex",window.addEventListener("keydown",tc)}function tc(e){"Escape"===e.key&&(nc(),ic(),lc(),window.removeEventListener("keydown",tc))}function nc(){N.formLogin.style.display="none"}function ic(){N.signInContainer.style.display="none"}function rc(e){N.divLoginError1.style.display="block",N.lblLoginErrorMessage1.innerHTML=`Error: ${e.message}`}Yl="Browser",Je(new _e("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=n.options;return((e,n)=>{Ns(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Ns(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:o,clientPlatform:Yl,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:_a(Yl)},s=new ba(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Rs);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(s,t),s})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Je(new _e("auth-internal",(e=>{const t=wa(e.getProvider("auth").getImmediate());return new Ql(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),it("@firebase/auth","0.20.2",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Yl)),it("@firebase/auth","0.20.2","esm2017"),N.signUpBtn.addEventListener("click",(function(){ec(),ic(),yc(),N.signUpContainer.style.display="flex"})),N.signUpButtonClose.addEventListener("click",(()=>{nc(),lc()}));const oc=window.location.hash.substring(1);function sc(){N.divLoginError2.style.display="none",N.lblLoginErrorMessage2.innerHTML=""}function ac(e){N.divLoginError2.style.display="block","auth/wrong-password"==e.code?N.lblLoginErrorMessage2.innerHTML="ua"===oc?"Невірний пароль. Спробуйте ще раз.":"Wrong password. Try again.":N.lblLoginErrorMessage2.innerHTML="ua"===oc?`Помилка: ${e.message}`:`Error: ${e.message}`}function lc(){N.signUpContainer.style.display="none"}function cc(){ec(),lc(),yc(),N.signInContainer.style.display="flex"}N.signInBtn.addEventListener("click",cc),N.signInLogin.addEventListener("click",cc),N.signInButtonClose.addEventListener("click",(()=>{nc(),ic(),gc()}));const uc=window.location.hash.substring(1),dc=function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw et.create("bad-app-name",{appName:String(i)});const r=Ke.get(i);if(r){if(oe(e,r.options)&&oe(n,r.config))return r;throw et.create("duplicate-app",{appName:i})}const o=new be(i);for(const e of Ye.values())o.addComponent(e);const s=new tt(e,n,o);return Ke.set(i,s),s}({apiKey:"AIzaSyDcQX36y9qDVvGT9ex-Dyg3NuMiItVzDWw",authDomain:"filmoteka-goit-6e05f.firebaseapp.com",databaseURL:"https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com",projectId:"filmoteka-goit-6e05f",storageBucket:"filmoteka-goit-6e05f.appspot.com",messagingSenderId:"281727023613",appId:"1:281727023613:web:ae072f932b4bc661d88194"}),hc=Jl(dc);async function pc(e,t){try{await Xa(hc,e,t),Zl(),nc()}catch(e){console.log(`There was an error: ${e}`),rc(e),Zl()}}async function mc(e,t){try{await Ga(hc,e,t),Zl(),sc(),nc()}catch(e){console.log(e),ac(e),Zl()}}async function fc(){try{await(e=hc,ye(e).signOut()),N.overlayBackdrop.style.display="flex"}catch(e){console.log(e)}var e}async function gc(){var e,t,n;e=e=>{e?(sc(),N.boxLoginLogout.style.display="flex",N.loginUser.innerHTML=`${e.email} `,N.btnLogout.removeEventListener("click",ec),N.btnLogout.addEventListener("click",fc),N.btnLogout.innerHTML="ua"===uc?"Вийти":"Log out",N.loginContainer.classList.add("is-hidden")):(N.loginContainer.classList.remove("is-hidden"),N.boxLoginLogout.style.display="none",N.btnLogout.removeEventListener("click",fc),N.btnLogout.addEventListener("click",ec))},ye(hc).onAuthStateChanged(e,t,n)}function yc(){N.overlayBackdrop.style.display="none",xu()}gc(),N.registerFormSignUp.addEventListener("submit",(e=>{e.preventDefault();pc(e.target.email.value.trim(),e.target.password.value.trim())})),N.registerFormSignIn.addEventListener("submit",(e=>{e.preventDefault();mc(e.target.email.value.trim(),e.target.password.value.trim())})),N.overlayBtnClose.addEventListener("click",yc),N.overlayBtn.addEventListener("click",cc),N.btnLogout.addEventListener("click",fc);const _c=function(e=nt(),t){return Ze(e,"database").getImmediate({identifier:t})}(dc),vc=Jl(dc);function bc(){var e;return null===(e=vc.currentUser)||void 0===e?void 0:e.uid}function wc(e,t,n){return ds(as(_c,`users/${n}/${e}${t}`)).then((e=>e.exists()))}function xc(e,t){const n=e.target.dataset.movie,i=Number(e.target.dataset.id);switch(e.target.id){case"add-to-watched":us(as(_c,`users/${t}/watchedMovies/${i}`),n),ou(e.target),Vc(e.target);break;case"add-to-queue":us(as(_c,`users/${t}/queueOfMovies/${i}`),n),ou(e.target),Vc(e.target);break;case"remove-from-watched":if(cs(as(_c,`users/${t}/watchedMovies/${i}`)),ou(e.target),!N.showLibraryBtn.classList.contains(Hc))return;su(Zc),Vc(e.target);break;case"remove-from-queue":if(cs(as(_c,`users/${t}/queueOfMovies/${i}`)),ou(e.target),!N.showLibraryBtn.classList.contains(Hc))return;su(eu),Vc(e.target)}}function kc(e){const t=bc();return ds(ls(as(_c),`users/${t}/${e}`)).then((e=>{if(e.exists()){return e.val()}return N.filmsContainer.innerHTML="",void Xc()}))}const Cc=new h,Ic=new d,Nc=window.location.hash.substring(1),Tc={ul:document.getElementById("pagination_list"),filmsContainer:document.querySelector(".films__container")};let Ec=1;function Sc(e,t=1){let n="";if(t>1&&(n+='<li><button class="arrow" type=\'button\' data-page="previous">&#8592;</button></li>'),window.innerWidth<=768)if(e<=5)for(let i=1;i<=e;i+=1)n+=i===t?`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`;else for(let i=1;i<=e;i+=1)i===t?n+=`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:i>t+2||i<t-2?(i<6&&t<3&&(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`),i>e-5&&t>e-2&&(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`)):n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`;else if(e<=7)for(let i=1;i<=e;i+=1)n+=i===t?`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`;else for(let i=1;i<=e;i+=1)i===t?n+=`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:1===i?t<=3?n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`:(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`,n+=' <li><p class="points">&#8230;</p></li>'):i===e?(t>=e-3||(n+=' <li><p class="points">&#8230;</p></li>'),n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`):i>t+2||i<t-2||(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`);t<e&&(n+='<li><button class="arrow" type=\'button\' data-page="next">&#8594;</button></li>'),Tc.ul.innerHTML=n}async function Rc(t){if(C(),Tc.filmsContainer.innerHTML="","search"===au){if(Ic.query=lu,Ic.setPage(t),""===Ic.query)return"ua"===Nc?e(w).Notify.info("Введіть, будь ласка, дані пошуку.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Please enter search data.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});const n=u();Ic.searchFilm(n).then((n=>{const i=n.results;if(Sc(n.total_pages,t),0===i.length)return"ua"===Nc?e(w).Notify.info("На жаль, немає фільмів, які відповідають вашому пошуковому запиту. Будь ласка, спробуйте ще раз.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Sorry, there are no movies matching your search query. Please try again.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});{const e=f(n);Tc.filmsContainer.insertAdjacentHTML("afterbegin",e)}})).catch((e=>console.log(e)))}else{Cc.setPage(t);try{const e=await Cc.fetchFilmsCards();Sc(e.total_pages,t);const n=f(e);Tc.filmsContainer.insertAdjacentHTML("afterbegin",n)}catch(e){console.log(e.message)}}I()}function Lc(e){if("button"===e.target.type){const t=e.currentTarget.id,n=e.target.dataset.page;"next"===n||"previous"===n||(Ec=Number(n)),Pc(Ec,t)}}async function Pc(e,t){switch(C(),t){case"library-pagination-watched":const t=await kc(Zc);if(!t)return;const n=Object.values(t);T(n.slice(20*e-20,20*e)),Sc(Math.ceil(n.length/20),e),I();break;case"library-pagination-queue":const i=await kc(eu);if(!i)return;const r=Object.values(i);T(r.slice(20*e-20,20*e)),Sc(Math.ceil(r.length/20),e),I()}}Tc.ul.addEventListener("click",(function(e){if("button"===e.target.type){const t=e.target.dataset.page;"next"===t?(Ec+=1,Rc(Ec)):"previous"===t?(Ec-=1,Rc(Ec)):(Ec=Number(t),Rc(Ec))}}));const{showWatchedBtn:Ac,showQueueBtn:Oc,showLibraryBtn:Mc,showHomeBtn:Dc,libraryButtons:Fc,search:zc,header:Wc,emptyListMessage:Bc,paginationButtons:Uc,paginationContainer:qc}=N,jc=window.location.hash.substring(1),Hc="current-link";function $c(){Ac.classList.add("active"),Oc.classList.remove("active")}function Vc(e){e.classList.add("disabled")}function Xc(){Bc.classList.remove("is-hidden"),qc.classList.add("is-hidden")}function Gc(){Bc.classList.add("is-hidden"),qc.classList.remove("is-hidden")}function Kc(){Uc.id="library-pagination-watched";document.getElementById("library-pagination-watched").addEventListener("click",Lc)}function Yc(){Uc.id="library-pagination-queue";document.getElementById("library-pagination-queue").addEventListener("click",Lc)}function Qc(e){Sc(Math.ceil(Object.values(e).length/20))}function Jc(){return"ua"===jc?w.Notify.warning("Увійдіть у свій акаунт, будь-ласка",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):w.Notify.warning("You should sign in first!",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1})}const Zc="watchedMovies/",eu="queueOfMovies/";function tu(e){switch(C(),Gc(),e.target.id){case"watched":$c(),su(Zc);break;case"queue":Oc.classList.add("active"),Ac.classList.remove("active"),su(eu)}I()}function nu(e){C();const t=bc();t?(xc(e,t),I()):Jc()}function iu(e){const{addToWatchedBtn:t,addToQueueBtn:n}=e;t.addEventListener("click",nu),n.addEventListener("click",nu)}async function ru(e,t){const{addToWatchedBtn:n,addToQueueBtn:i}=t,r=bc();n.setAttribute("data-movie",JSON.stringify(e)),i.setAttribute("data-movie",JSON.stringify(e)),n.setAttribute("data-id",e.id),i.setAttribute("data-id",e.id);await wc(Zc,e.id,r)&&function(e){e.id="remove-from-watched",e.textContent="ua"===jc?"Видалити з переглянутих":"Delete from watched"}(n);await wc(eu,e.id,r)&&function(e){e.id="remove-from-queue",e.textContent="ua"===jc?"Видалити з обраних":"Delete from queue"}(i)}function ou(e){e.removeAttribute("data-movie"),e.removeAttribute("data-id")}async function su(e){const t=await kc(e);if(!t)return;const n=function(e){return Object.values(e).length>20?Object.values(e).slice(0,20):Object.values(e)}(t);switch(Qc(t),T(n),e){case Zc:Kc();break;case eu:Yc()}}let au,lu;N.showWatchedBtn.addEventListener("click",tu),N.showQueueBtn.addEventListener("click",tu),N.showLibraryBtn.addEventListener("click",(function(){C();if(!bc())return void Jc();Kc(),Mc.classList.add(Hc),Dc.classList.remove(Hc),Fc.classList.remove("is-hidden"),zc.classList.add("is-hidden"),Wc.classList.add("header__background-library"),Wc.classList.remove("header__background"),$c(),su(Zc),I()})),N.showHomeBtn.addEventListener("click",(function(){Gc(),Fc.classList.add("is-hidden"),zc.classList.remove("is-hidden"),Wc.classList.remove("header__background-library"),Wc.classList.add("header__background"),Uc.id="pagination_list"}));const cu=new d,uu=new h,du=window.location.hash.substring(1),hu=document.querySelector(".films__container"),pu=document.querySelector(".backdrop"),mu=document.querySelector(".modal_film-info"),fu=document.querySelector(".modal_film__button--close"),gu=document.querySelector(".search-form"),yu=document.getElementById("home"),_u=document.getElementById("library"),vu=document.querySelector(".logo"),bu=document.querySelector(".buttons"),wu=document.querySelector("[team-data-close]");async function xu(){gu[0].value="",Nu(),uu.resetPage(),yu.classList.add("current-link"),_u.classList.remove("current-link"),gu.classList.remove("is-hidden"),bu.classList.add("is-hidden"),C();try{const e=await uu.fetchFilmsCards();au="popular",Sc(e.total_pages);const t=f(e);hu.insertAdjacentHTML("afterbegin",t)}catch(e){console.log(e.message)}I()}function ku(e){e.target===pu&&(pu.classList.add("is-hidden"),document.body.classList.toggle("modal-open"),pu.removeEventListener("click",ku))}function Cu(e){"Escape"===e.code&&(pu.classList.add("is-hidden"),document.body.classList.toggle("modal-open"),document.removeEventListener("keydown",Cu))}function Iu(){pu.classList.add("is-hidden"),document.body.classList.toggle("modal-open"),pu.removeEventListener("click",ku)}function Nu(){hu.innerHTML=""}document.addEventListener("DOMContentLoaded",xu),yu.addEventListener("click",xu),vu.addEventListener("click",(function(e){e.preventDefault(),xu()})),hu.addEventListener("click",(function(t){if(C(),t.preventDefault(),mu.innerHTML="",!t.target.dataset.id)return;{const n=u();_(t.target.dataset.id,n).then((t=>{if(!t)return"ua"===du?e(w).Notify.info("Ваш запит не знайдено.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("The resource you requested could not be found.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});{const e=y(t);pu.classList.remove("is-hidden"),document.body.classList.toggle("modal-open"),fu.addEventListener("click",Iu),pu.addEventListener("click",ku),document.addEventListener("keydown",Cu),mu.insertAdjacentHTML("beforeend",e),c();const n={addToWatchedBtn:document.getElementById("add-to-watched"),addToQueueBtn:document.getElementById("add-to-queue")};iu(n),ru(t,n)}})).catch((e=>console.log(e)))}I()})),gu.addEventListener("submit",(function(t){if(t.preventDefault(),lu=t.currentTarget.elements.searchQuery.value.trim(),cu.query=t.currentTarget.elements.searchQuery.value.trim(),""===cu.query)return"ua"===du?e(w).Notify.info("Введіть, будь ласка, дані пошуку.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Please enter search data.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});C(),cu.resetPage();const n=u();cu.searchFilm(n).then((t=>{if(0===t.results.length)return"ua"===du?e(w).Notify.info("На жаль, немає фільмів, які відповідають вашому пошуковому запиту. Будь ласка, спробуйте ще раз.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Sorry, there are no movies matching your search query. Please try again.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});{Nu();const e=f(t);hu.insertAdjacentHTML("afterbegin",e)}au="search",Sc(t.total_pages)})).catch((e=>console.log(e))),I()})),wu.addEventListener("click",l),(()=>{const e={openModalBtn:document.querySelector("[team-data-modal]"),closeModalBtn:document.querySelector("[team-data-close]"),modal:document.querySelector("[team-data]")};function t(){e.modal.classList.toggle("is-hidden")}e.openModalBtn.addEventListener("click",t),e.closeModalBtn.addEventListener("click",t)})();const Tu=document.getElementById("change-theme-btn");function Eu(){document.body.classList.add("dark"),Tu.textContent="🌞",localStorage.setItem("theme","dark")}Tu.addEventListener("click",(()=>{document.body.classList.contains("dark")?(document.body.classList.remove("dark"),Tu.textContent="🌙",localStorage.setItem("theme","light")):Eu()})),"dark"===localStorage.getItem("theme")&&Eu();const Su=document.getElementById("scroll-top");window.onscroll=function(){document.body.scrollTop>700||document.documentElement.scrollTop>700?Su.classList.remove("scroll-top_show"):Su.classList.add("scroll-top_show")},Su.onclick=()=>{window.scrollTo(0,0)};
//# sourceMappingURL=index.cf9137b0.js.map
