 ...
 * limitations under the License.
 */
function _(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function C(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function T(){const e=_();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}class S extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name="FirebaseError",Object.setPrototypeOf(this,S.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,E.prototype.create)}}class E{create(e,...t){const i=t[0]||{},n=`${this.service}/${e}`,a=this.errors[e],r=a?function(e,t){return e.replace(L,((e,i)=>{const n=t[i];return null!=n?String(n):`<${i}?>`}))}(a,i):"Error",o=`${this.serviceName}: ${r} (${n}).`;return new S(n,o,i)}constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}}const L=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(e="[DEFAULT]"){const t=ye.get(e);if(!t)throw Ie.create("no-app",{appName:e});return t}function Ce(e,t,i){var n;let a=null!==(n=be[e])&&void 0!==n?n:e;i&&(a+=`-${i}`);const r=a.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const e=[`Unable to register library "${a}" with version "${t}":`];return r&&e.push(`library name "${a}" contains illegal characters (whitespace or "/")`),r&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void ge.warn(e.join(" "))}we(new F(`${a}-version`,(()=>({library:a,version:t})),"VERSION"))}let Te=null;function Se(){return Te||(Te=de("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw Ie.create("storage-open",{originalErrorMessage:e.message})}))),Te}async function Ee(e,t){try{const i=(await Se()).transaction("firebase-heartbeat-store","readwrite"),n=i.objectStore("firebase-heartbeat-store");return await n.put(t,Le(e)),i.done}catch(e){throw Ie.create("storage-set",{originalErrorMessage:e.message})}}function Le(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var De;De="",we(new F("platform-logger",(e=>new he(e)),"PRIVATE")),we(new F("heartbeat",(e=>new Re(e)),"PRIVATE")),Ce("@firebase/app","0.7.25",De),Ce("@firebase/app","0.7.25","esm2017"),Ce("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
class xt{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){$e(e.idToken,"internal-error"),$e(void 0!==e.idToken,"internal-error"),$e(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=ht(e);return $e(t,"internal-error"),$e(void 0!==t.exp,"internal-error"),$e(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return $e(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:i,refreshToken:n,expiresIn:a}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tt(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Rt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(St(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ot(t))return"Blackberry";if(Mt(t))return"Webos";if(Et(t))return"Safari";if((t.includes("chrome/")||Lt(t))&&!t.includes("edge/"))return"Chrome";if(At(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=e.match(t);if(2===(null==i?void 0:i.length))return i[1]}return"Other"}function St(e=_()){return/firefox\//i.test(e)}function Et(e=_()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Lt(e=_()){return/crios\//i.test(e)}function Rt(e=_()){return/iemobile/i.test(e)}function At(e=_()){return/android/i.test(e)}function Ot(e=_()){return/blackberry/i.test(e)}function Mt(e=_()){return/webos/i.test(e)}function Dt(e=_()){return/iphone|ipad|ipod/i.test(e)}function zt(){return T()&&10===document.documentMode}function Pt(e=_()){return Dt(e)||At(e)||Mt(e)||Ot(e)||/windows phone/i.test(e)||Rt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jt{static parseLink(e){const t=function(e){const t=D(z(e)).link,i=t?D(z(t)).deep_link_id:null,n=D(z(e)).deep_link_id;return(n?D(z(n)).link:null)||n||i||t||e}(e);try{return new Jt(t)}catch(e){return null}}constructor(e){var t,i,n,a,r,o;const s=D(z(e)),l=null!==(t=s.apiKey)&&void 0!==t?t:null,c=null!==(i=s.oobCode)&&void 0!==i?i:null,d=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(n=s.mode)&&void 0!==n?n:null);$e(l&&c&&d,"argument-error"),this.apiKey=l,this.operation=d,this.code=c,this.continueUrl=null!==(a=s.continueUrl)&&void 0!==a?a:null,this.languageCode=null!==(r=s.languageCode)&&void 0!==r?r:null,this.tenantId=null!==(o=s.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function xi(e="",t=10){let i="";for(let e=0;e<t;e++)i+=Math.floor(10*Math.random());return e+i}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vi.receivers=[];class wi{removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,i=50){const n="undefined"!=typeof MessageChannel?new MessageChannel:null;if(!n)throw new Error("connection_unavailable");let a,r;return new Promise(((o,s)=>{const l=xi("",20);n.port1.start();const c=setTimeout((()=>{s(new Error("unsupported_event"))}),i);r={messageChannel:n,onMessage(e){const t=e;if(t.data.eventId===l)switch(t.data.status){case"ack":clearTimeout(c),a=setTimeout((()=>{s(new Error("timeout"))}),3e3);break;case"done":clearTimeout(a),o(t.data.response);break;default:clearTimeout(c),clearTimeout(a),s(new Error("invalid_response"))}}},this.handlers.add(r),n.port1.addEventListener("message",r.onMessage),this.target.postMessage({eventType:e,eventId:l,data:t},[n.port2])})).finally((()=>{r&&this.removeMessageHandler(r)}))}constructor(e){this.target=e,this.handlers=new Set}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ri(e){return new Promise(((t,i)=>{const n=document.createElement("script");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Mi{verifyPhoneNumber(e,t){return Oi(this.auth,e,U(t))}static credential(e,t){return Gt._fromVerification(e,t)}static credentialFromResult(e){const t=e;return Mi.credentialFromTaggedObject(t)}static credentialFromError(e){return Mi.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:i}=e;return t&&i?Gt._fromTokenResponse(t,i):null}constructor(e){this.providerId=Mi.PROVIDER_ID,this.auth=Ft(e)}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Di(e,t){return t?Je(t):($e(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nn=new tt(3e4,6e4);function an(){const e=ki().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let rn=null;function on(e){return rn=rn||function(e){return new Promise(((t,i)=>{var n,a,r;function o(){an(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{an(),i(He(e,"network-request-failed"))},timeout:nn.get()})}if(null===(a=null===(n=ki().gapi)||void 0===n?void 0:n.iframes)||void 0===a?void 0:a.Iframe)t(gapi.iframes.getContext());else{if(!(null===(r=ki().gapi)||void 0===r?void 0:r.load)){const t=Ai("iframefcb");return ki()[t]=()=>{gapi.load?o():i(He(e,"network-request-failed"))},Ri(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>i(e)))}o()}})).catch((e=>{throw rn=null,e}))}(e),rn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function(e=_e()){const t=ke(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const i=ke(e,"auth");if(i.isInitialized()){const e=i.getImmediate();if(A(i.getOptions(),null!=t?t:{}))return e;je(e,"already-initialized")}return i.initialize({options:t})}(e,{popupRedirectResolver:hn,persistence:[Li,gi,yi]})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const i=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),n=i.name;if("string"!=typeof n||!n)throw Ie.create("bad-app-name",{appName:String(n)});const a=ye.get(n);if(a){if(A(e,a.options)&&A(i,a.config))return a;throw Ie.create("duplicate-app",{appName:n})}const r=new H(n);for(const e of ve.values())r.addComponent(e);const o=new Ne(e,i,r);return ye.set(n,o),o}({apiKey:"AIzaSyDcQX36y9qDVvGT9ex-Dyg3NuMiItVzDWw",authDomain:"filmoteka-goit-6e05f.firebaseapp.com",databaseURL:"https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com",projectId:"filmoteka-goit-6e05f",storageBucket:"filmoteka-goit-6e05f.appspot.com",messagingSenderId:"281727023613",appId:"1:281727023613:web:ae072f932b4bc661d88194"}));async function Sn(e,t,i){try{await pi(Tn,t,i),await updateProfile(Tn.currentUser,{displayName:e})}catch(e){console.log(`There was an error: ${e}`)}}async function En(e,t){try{const r=await(i=Tn,n=e,a=t,mi(U(i),Qt.credential(n,a)));console.log(r.user),vn(),kn()}catch(e){console.log(e),Nn(e),vn()}var i,n,a;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}async function Ln(){try{await(e=Tn,U(e).signOut()),console.log("loged out")}catch(e){}var e}yn.btnLogout.addEventListener("click",Ln),yn.registerFormSignUp.addEventListener("submit",(e=>{e.preventDefault();Sn(e.target.name.value,e.target.email.value,e.target.password.value)})),yn.registerFormSignIn.addEventListener("submit",(e=>{e.preventDefault();En(e.target.email.value,e.target.password.value)}));class Rn{create(e){return fetch(this.URL,{method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"applicatiom/json"}}).then((e=>e.json())).then((t=>(e.id=t.name,e)))}getUser(){return fetch(this.URL).then((e=>e.json())).then((e=>console.log(e)))}fetch(e){return e?fetch(`https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com/users.json?auth=${e}`).then((e=>e.json())).then((e=>e&&e.error?`<p>${e.error}</p>`:e?Object.keys(e).map((t=>({...e[t],id:t}))):[])):Promise.resolve(console.error(error))}constructor(){this.URL="https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com/users.json"}}new Rn;console.log("start");const An=new i,On={ul:document.getElementById("pagination_list"),filmsContainer:document.querySelector(".films__container")};function Mn(e,t){let i="";t>1&&(i+='<li><button class="arrow" data-page="previous">&#8592;</button></li>');for(let n=1;n<=e;n+=1)i+=n===t?`<li><button class="numbers active" data-page="${n}">${n}</button></li>`:`<li><button class="numbers" data-page="${n}">${n}</button></li>`;t<e&&(i+='<li><button class="arrow" data-page="next">&#8594;</button></li>'),On.ul.innerHTML=i}Mn(10,1),On.ul.addEventListener("click",(async function(e){const t=e.target.dataset.page;On.filmsContainer.innerHTML="",An.setPage(Number(t));try{const e=await An.fetchFilmsCards();e[0].total_pages;Mn(10,Number(t));const i=n(e);On.filmsContainer.insertAdjacentHTML("afterbegin",i)}catch(e){console.log(e.message)}})),(()=>{const e={openModalBtn:document.querySelector("[team-data-modal]"),closeModalBtn:document.querySelector("[team-data-close]"),modal:document.querySelector("[team-data]")};function t(){e.modal.classList.toggle("is-hidden")}e.openModalBtn.addEventListener("click",t),e.closeModalBtn.addEventListener("click",t)})();
//# sourceMappingURL=index.98e272d7.js.map
