 ...
 * limitations under the License.
 */
function _(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function T(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function C(){const e=_();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}class S extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name="FirebaseError",Object.setPrototypeOf(this,S.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,E.prototype.create)}}class E{create(e,...t){const i=t[0]||{},n=`${this.service}/${e}`,a=this.errors[e],r=a?function(e,t){return e.replace(R,((e,i)=>{const n=t[i];return null!=n?String(n):`<${i}?>`}))}(a,i):"Error",o=`${this.serviceName}: ${r} (${n}).`;return new S(n,o,i)}constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}}const R=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Me;Me="",we(new F("platform-logger",(e=>new he(e)),"PRIVATE")),we(new F("heartbeat",(e=>new Le(e)),"PRIVATE")),Te("@firebase/app","0.7.25",Me),Te("@firebase/app","0.7.25","esm2017"),Te("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function et(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(Ye()||T()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _t(e,t,i){return`firebase:${e}:${t}:${i}`}class Tt{setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?kt._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();return await this.removeCurrentUser(),this.persistence=e,t?this.setCurrentUser(t):void 0}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new Tt(Je(Nt),e,i);const n=(await Promise.all(t.map((async e=>{if(await e._isAvailable())return e})))).filter((e=>e));let a=n[0]||Je(Nt);const r=_t(i,e.config.apiKey,e.name);let o=null;for(const i of t)try{const t=await i._get(r);if(t){const n=kt._fromJSON(e,t);i!==a&&(o=n),a=i;break}}catch(e){}const s=n.filter((e=>e._shouldAllowMigration));return a._shouldAllowMigration&&s.length?(a=s[0],o&&await a._set(r,o.toJSON()),await Promise.all(t.map((async e=>{if(e!==a)try{await e._remove(r)}catch(e){}}))),new Tt(a,e,i)):new Tt(a,e,i)}constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:n,name:a}=this.auth;this.fullUserKey=_t(this.userKey,n.apiKey,a),this.fullPersistenceKey=_t("persistence",n.apiKey,a),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Lt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(St(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ot(t))return"Blackberry";if(Dt(t))return"Webos";if(Et(t))return"Safari";if((t.includes("chrome/")||Rt(t))&&!t.includes("edge/"))return"Chrome";if(At(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=e.match(t);if(2===(null==i?void 0:i.length))return i[1]}return"Other"}function St(e=_()){return/firefox\//i.test(e)}function Et(e=_()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Rt(e=_()){return/crios\//i.test(e)}function Lt(e=_()){return/iemobile/i.test(e)}function At(e=_()){return/android/i.test(e)}function Ot(e=_()){return/blackberry/i.test(e)}function Dt(e=_()){return/webos/i.test(e)}function Mt(e=_()){return/iphone|ipad|ipod/i.test(e)}function zt(){return C()&&10===document.documentMode}function Pt(e=_()){return Mt(e)||At(e)||Dt(e)||Ot(e)||/windows phone/i.test(e)||Lt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Wt(e,t=[]){let i;switch(e){case"Browser":i=Ct(_());break;case"Worker":i=`${Ct(_())}-${e}`;break;default:i=e}return`${i}/JsCore/9.8.2/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gn="Browser",we(new F("auth",((e,{options:t})=>{const i=e.getProvider("app").getImmediate(),n=e.getProvider("heartbeat"),{apiKey:a,authDomain:r}=i.options;return((e,i)=>{$e(a&&!a.includes(":"),"invalid-api-key",{appName:e.name}),$e(!(null==r?void 0:r.includes(":")),"argument-error",{appName:e.name});const n={apiKey:a,authDomain:r,clientPlatform:gn,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Wt(gn)},o=new Ut(e,i,n);return function(e,t){const i=(null==t?void 0:t.persistence)||[],n=(Array.isArray(i)?i:[i]).map(Je);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(n,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(i,n)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,i)=>{e.getProvider("auth-internal").initialize()}))),we(new F("auth-internal",(e=>{const t=Ft(e.getProvider("auth").getImmediate());return new bn(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Te("@firebase/auth","0.20.2",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(gn)),Te("@firebase/auth","0.20.2","esm2017");var yn={signUpButton:document.getElementById("signUpBtn"),signInButton:document.getElementById("signInBtn"),container:document.getElementById("container"),registerFormSignUp:document.querySelector(".register-form__sign-up"),registerFormSignIn:document.querySelector(".register-form__sign-in"),btnLogin:document.getElementById("btnLoginBtn"),btnSignup:document.getElementById("btnSignUpBtn"),btnLogout:document.getElementById("btnLogout"),formLogin:document.getElementById("formLogin"),txtEmailLogin:document.getElementById("txtEmailLogin"),txtPasswordLogin:document.getElementById("txtPasswordLogin"),txtNameRegister:document.getElementById("txtNameRegister"),txtEmailRegister:document.getElementById("txtEmailRegister"),txtPasswordRegister:document.getElementById("txtPasswordRegister"),loginUser:document.getElementById("loginUser"),divLoginError:document.getElementById("divLoginError"),lblLoginErrorMessage:document.getElementById("lblLoginErrorMessage")};function xn(){yn.txtEmailLogin.value="",yn.txtPasswordLogin.value="",yn.txtEmailRegister.value="",yn.txtPasswordRegister.value=""}function vn(){yn.formLogin.style.display="none"}yn.registerFormSignUp.addEventListener("submit",(function(){kn(),xn(),vn()})),vn(),yn.registerFormSignIn.addEventListener("submit",(function(){In(),yn.divLoginError.style.display="none",yn.lblLoginErrorMessage.innerHTML="",xn(),vn()}));const wn=
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class Nn{create(e){return fetch(this.URL,{method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"applicatiom/json"}}).then((e=>e.json())).then((t=>(e.id=t.name,e)))}getUser(){return fetch(this.URL).then((e=>e.json())).then((e=>console.log(e)))}fetch(e){return e?fetch(`https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com/users.json?auth=${e}`).then((e=>e.json())).then((e=>e&&e.error?`<p>${e.error}</p>`:e?Object.keys(e).map((t=>({...e[t],id:t}))):[])):Promise.resolve(console.error(error))}constructor(){this.URL="https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com/users.json"}}new Nn;console.log("start");const _n=new i,Tn={ul:document.getElementById("pagination_list"),filmsContainer:document.querySelector(".films__container")};function Cn(e,t){let i="";t>1&&(i+='<li><button class="arrow" data-page="previous">&#8592;</button></li>');for(let n=1;n<=e;n+=1)i+=n===t?`<li><button class="numbers active" data-page="${n}">${n}</button></li>`:`<li><button class="numbers" data-page="${n}">${n}</button></li>`;t<e&&(i+='<li><button class="arrow" data-page="next">&#8594;</button></li>'),Tn.ul.innerHTML=i}Cn(10,1),Tn.ul.addEventListener("click",(async function(e){const t=e.target.dataset.page;Tn.filmsContainer.innerHTML="",_n.setPage(Number(t));try{const e=await _n.fetchFilmsCards();e[0].total_pages;Cn(10,Number(t));const i=n(e);Tn.filmsContainer.insertAdjacentHTML("afterbegin",i)}catch(e){console.log(e.message)}}));
//# sourceMappingURL=index.ecbfe4b8.js.map
