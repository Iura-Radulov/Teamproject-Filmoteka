 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ut;ut="",Ye(new ge("platform-logger",(e=>new He(e)),"PRIVATE")),Ye(new ge("heartbeat",(e=>new st(e)),"PRIVATE")),tt("@firebase/app","0.7.25",ut),tt("@firebase/app","0.7.25","esm2017"),tt("fire-js","");var ht,dt,pt,mt=ht={};function ft(){throw new Error("setTimeout has not been defined")}function gt(){throw new Error("clearTimeout has not been defined")}function yt(e){if(dt===setTimeout)return setTimeout(e,0);if((dt===ft||!dt)&&setTimeout)return dt=setTimeout,setTimeout(e,0);try{return dt(e,0)}catch(t){try{return dt.call(null,e,0)}catch(t){return dt.call(this,e,0)}}}!function(){try{dt="function"==typeof setTimeout?setTimeout:ft}catch(e){dt=ft}try{pt="function"==typeof clearTimeout?clearTimeout:gt}catch(e){pt=gt}}();var _t,vt=[],bt=!1,wt=-1;function xt(){bt&&_t&&(bt=!1,_t.length?vt=_t.concat(vt):wt=-1,vt.length&&kt())}function kt(){if(!bt){var e=yt(xt);bt=!0;for(var t=vt.length;t;){for(_t=vt,vt=[];++wt<t;)_t&&_t[wt].run();wt=-1,t=vt.length}_t=null,bt=!1,function(e){if(pt===clearTimeout)return clearTimeout(e);if((pt===gt||!pt)&&clearTimeout)return pt=clearTimeout,clearTimeout(e);try{pt(e)}catch(t){try{return pt.call(null,e)}catch(t){return pt.call(this,e)}}}(e)}}function Ct(e,t){this.fun=e,this.array=t}function It(){}mt.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];vt.push(new Ct(e,t)),1!==vt.length||bt||yt(kt)},Ct.prototype.run=function(){this.fun.apply(null,this.array)},mt.title="browser",mt.browser=!0,mt.env={},mt.argv=[],mt.version="",mt.versions={},mt.on=It,mt.addListener=It,mt.once=It,mt.off=It,mt.removeListener=It,mt.removeAllListeners=It,mt.emit=It,mt.prependListener=It,mt.prependOnceListener=It,mt.listeners=function(e){return[]},mt.binding=function(e){throw new Error("process.binding is not supported")},mt.cwd=function(){return"/"},mt.chdir=function(e){throw new Error("process.chdir is not supported")},mt.umask=function(){return 0};
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const un={},hn={};function dn(e){const t=e.toString();return un[t]||(un[t]=new cn),un[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/oi,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}}const ai=function(e,t,n,i){e.sort(t);const r=function(t,i){const o=i-t;let s,a;if(0===o)return null;if(1===o)return s=e[t],a=n?n(s):s,new Xn(a,s.node,Xn.BLACK,null,null);{const l=parseInt(o/2,10)+t,c=r(t,l),u=r(l+1,i);return s=e[l],a=n?n(s):s,new Xn(a,s.node,Xn.BLACK,c,u)}},o=function(t){let i=null,o=null,s=e.length;const a=function(t,i){const o=s-t,a=s;s-=t;const c=r(o+1,a),u=e[o],h=n?n(u):u;l(new Xn(h,u.node,i,null,c))},l=function(e){i?(i.left=e,i=e):(o=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,Xn.BLACK):(a(i,Xn.BLACK),a(i,Xn.RED))}return o}(new si(e.length));return new Gn(i||t,o)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class fi extends qn{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?$t(e.name,t.name):r}makePost(e,t){const n=mi(e),i=di.EMPTY_NODE.updateChild(this.indexPath_,n);return new Un(t,i)}maxPost(){const e=di.EMPTY_NODE.updateChild(this.indexPath_,pi);return new Un("[MAX_NAME]",e)}toString(){return Sn(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,S(!Pn(e)&&".priority"!==In(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{updateChild(e,t,n,i,r,o){return this.rangedFilter_.matches(new Un(t,n))||(n=di.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,i,r,o):this.fullLimitUpdateChild_(e,t,n,r,o)}updateFullNode(e,t,n){let i;if(t.isLeafNode()||t.isEmpty())i=di.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;i=di.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();let r;if(r=this.reverse_?this.index_.compare(this.rangedFilter_.getStartPost(),t)<=0:this.index_.compare(t,this.rangedFilter_.getEndPost())<=0,!r)break;i=i.updateImmediateChild(t.name,t.node),n++}}else{let e,n,r,o;if(i=t.withIndex(this.index_),i=i.updatePriority(di.EMPTY_NODE),this.reverse_){o=i.getReverseIterator(this.index_),e=this.rangedFilter_.getEndPost(),n=this.rangedFilter_.getStartPost();const t=this.index_.getCompare();r=(e,n)=>t(n,e)}else o=i.getIterator(this.index_),e=this.rangedFilter_.getStartPost(),n=this.rangedFilter_.getEndPost(),r=this.index_.getCompare();let s=0,a=!1;for(;o.hasNext();){const t=o.getNext();!a&&r(e,t)<=0&&(a=!0);a&&s<this.limit_&&r(t,n)<=0?s++:i=i.updateImmediateChild(t.name,di.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,i,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,i,r){let o;if(this.reverse_){const e=this.index_.getCompare();o=(t,n)=>e(n,t)}else o=this.index_.getCompare();const s=e;S(s.numChildren()===this.limit_,"");const a=new Un(t,n),l=this.reverse_?s.getFirstChild(this.index_):s.getLastChild(this.index_),c=this.rangedFilter_.matches(a);if(s.hasChild(t)){const e=s.getImmediateChild(t);let u=i.getChildAfterChild(this.index_,l,this.reverse_);for(;null!=u&&(u.name===t||s.hasChild(u.name));)u=i.getChildAfterChild(this.index_,u,this.reverse_);const h=null==u?1:o(u,a);if(c&&!n.isEmpty()&&h>=0)return null!=r&&r.trackChildChange(wi(t,n,e)),s.updateImmediateChild(t,n);{null!=r&&r.trackChildChange(bi(t,e));const n=s.updateImmediateChild(t,di.EMPTY_NODE);return null!=u&&this.rangedFilter_.matches(u)?(null!=r&&r.trackChildChange(vi(u.name,u.node)),n.updateImmediateChild(u.name,u.node)):n}}return n.isEmpty()?e:c&&o(l,a)>=0?(null!=r&&(r.trackChildChange(bi(l.name,l.node)),r.trackChildChange(vi(t,n))),s.updateImmediateChild(t,n).updateImmediateChild(l.name,di.EMPTY_NODE)):e}constructor(e){this.rangedFilter_=new ki(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Si{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=di.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Nt="9.8.2",Ye(new ge("database",((e,{instanceIdentifier:t})=>ds(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),tt("@firebase/database","0.13.0",e),tt("@firebase/database","0.13.0","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qs(e){var t;const n=e.auth,i=await e.getIdToken(),r=await Gs(e,async function(e,t){return Ws(e,"POST","/v1/accounts:lookup",t)}(n,{idToken:i}));Cs(null==r?void 0:r.users.length,n,"internal-error");const o=r.users[0];e._notifyReloadListener(o);const s=(null===(t=o.providerUserInfo)||void 0===t?void 0:t.length)?o.providerUserInfo.map((e=>{var{providerId:t}=e,n=ms(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})):[];const a=(l=e.providerData,c=s,[...l.filter((e=>!c.some((t=>t.providerId===e.providerId)))),...c]);var l,c;const u=e.isAnonymous,h=!(e.email&&o.passwordHash||(null==a?void 0:a.length)),d=!!u&&h,p={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:a,metadata:new Ys(o.createdAt,o.lastLoginAt),isAnonymous:d};Object.assign(e,p)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oa(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(ca(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(sa(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(ha(t))return"Blackberry";if(da(t))return"Webos";if(aa(t))return"Safari";if((t.includes("chrome/")||la(t))&&!t.includes("edge/"))return"Chrome";if(ua(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function sa(e=W()){return/firefox\//i.test(e)}function aa(e=W()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function la(e=W()){return/crios\//i.test(e)}function ca(e=W()){return/iemobile/i.test(e)}function ua(e=W()){return/android/i.test(e)}function ha(e=W()){return/blackberry/i.test(e)}function da(e=W()){return/webos/i.test(e)}function pa(e=W()){return/iphone|ipad|ipod/i.test(e)}function ma(){return j()&&10===document.documentMode}function fa(e=W()){return pa(e)||ua(e)||da(e)||ha(e)||/windows phone/i.test(e)||ca(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var r,o;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=ws("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(o=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==o?o:document).appendChild(i)}))}function hl(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
hl("rcb"),new As(3e4,6e4);async function dl(e,t,n){var i;const r=await n.verify();try{let o;if(Cs("string"==typeof r,e,"argument-error"),Cs("recaptcha"===n.type,e,"argument-error"),o="string"==typeof t?{phoneNumber:t}:t,"session"in o){const t=o.session;if("phoneNumber"in o){Cs("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ml=new As(3e4,6e4);function Dl(){const e=tl().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Fl=null;function zl(e){return Fl=Fl||function(e){return new Promise(((t,n)=>{var i,r,o;function s(){Dl(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Dl(),n(ws(e,"network-request-failed"))},timeout:Ml.get()})}if(null===(r=null===(i=tl().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=tl().gapi)||void 0===o?void 0:o.load)){const t=hl("iframefcb");return tl()[t]=()=>{gapi.load?s():n(ws(e,"network-request-failed"))},ul(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Fl=null,e}))}(e),Fl}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
