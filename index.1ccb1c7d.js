 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Me;Me="",we(new F("platform-logger",(e=>new he(e)),"PRIVATE")),we(new F("heartbeat",(e=>new Re(e)),"PRIVATE")),Ce("@firebase/app","0.7.25",Me),Ce("@firebase/app","0.7.25","esm2017"),Ce("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tt(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Rt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(St(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ot(t))return"Blackberry";if(Dt(t))return"Webos";if(Et(t))return"Safari";if((t.includes("chrome/")||Lt(t))&&!t.includes("edge/"))return"Chrome";if(At(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=e.match(t);if(2===(null==i?void 0:i.length))return i[1]}return"Other"}function St(e=_()){return/firefox\//i.test(e)}function Et(e=_()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Lt(e=_()){return/crios\//i.test(e)}function Rt(e=_()){return/iemobile/i.test(e)}function At(e=_()){return/android/i.test(e)}function Ot(e=_()){return/blackberry/i.test(e)}function Dt(e=_()){return/webos/i.test(e)}function Mt(e=_()){return/iphone|ipad|ipod/i.test(e)}function zt(){return T()&&10===document.documentMode}function Pt(e=_()){return Mt(e)||At(e)||Dt(e)||Ot(e)||/windows phone/i.test(e)||Rt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
