 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hn{incrementCounter(e,t=1){te(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return z(this.counters_)}constructor(){this.counters_={}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dn={},pn={};function mn(e){const t=e.toString();return dn[t]||(dn[t]=new hn),dn[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class li{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/ai,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}}const ci=function(e,t,n,i){e.sort(t);const r=function(t,i){const o=i-t;let s,a;if(0===o)return null;if(1===o)return s=e[t],a=n?n(s):s,new Kn(a,s.node,Kn.BLACK,null,null);{const l=parseInt(o/2,10)+t,c=r(t,l),u=r(l+1,i);return s=e[l],a=n?n(s):s,new Kn(a,s.node,Kn.BLACK,c,u)}},o=function(t){let i=null,o=null,s=e.length;const a=function(t,i){const o=s-t,a=s;s-=t;const c=r(o+1,a),u=e[o],h=n?n(u):u;l(new Kn(h,u.node,i,null,c))},l=function(e){i?(i.left=e,i=e):(o=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,Kn.BLACK):(a(i,Kn.BLACK),a(i,Kn.RED))}return o}(new li(e.length));return new Yn(i||t,o)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ui;const hi={};class di{static get Default(){return L(hi&&si,"ChildrenNode.ts has not been loaded"),ui=ui||new di({".priority":hi},{".priority":si}),ui}get(e){const t=ne(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Yn?t:null}hasIndex(e){return te(this.indexSet_,e.toString())}addIndex(e,t){L(e!==Xn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const r=t.getIterator(jn.Wrap);let o,s=r.getNext();for(;s;)i=i||e.isDefinedOn(s.node),n.push(s),s=r.getNext();o=i?ci(n,e.getCompare()):hi;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const c=Object.assign({},this.indexes_);return c[a]=o,new di(c,l)}addToIndexes(e,t){const n=re(this.indexes_,((n,i)=>{const r=ne(this.indexSet_,i);if(L(r,"Missing index implementation for "+i),n===hi){if(r.isDefinedOn(e.node)){const n=[],i=t.getIterator(jn.Wrap);let o=i.getNext();for(;o;)o.name!==e.name&&n.push(o),o=i.getNext();return n.push(e),ci(n,r.getCompare())}return hi}{const i=t.get(e.name);let r=n;return i&&(r=r.remove(new jn(e.name,i))),r.insert(e,e.node)}}));return new di(n,this.indexSet_)}removeFromIndexes(e,t){const n=re(this.indexes_,(n=>{if(n===hi)return n;{const i=t.get(e.name);return i?n.remove(new jn(e.name,i)):n}}));return new di(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aa(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(ha(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(la(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(pa(t))return"Blackberry";if(ma(t))return"Webos";if(ca(t))return"Safari";if((t.includes("chrome/")||ua(t))&&!t.includes("edge/"))return"Chrome";if(da(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function la(e=U()){return/firefox\//i.test(e)}function ca(e=U()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function ua(e=U()){return/crios\//i.test(e)}function ha(e=U()){return/iemobile/i.test(e)}function da(e=U()){return/android/i.test(e)}function pa(e=U()){return/blackberry/i.test(e)}function ma(e=U()){return/webos/i.test(e)}function fa(e=U()){return/iphone|ipad|ipod/i.test(e)}function ga(){return $()&&10===document.documentMode}function ya(e=U()){return fa(e)||da(e)||ma(e)||pa(e)||/windows phone/i.test(e)||ha(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dl(e){return new Promise(((t,n)=>{const i=document.createElement("script");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fl=new Ms(3e4,6e4);function zl(){const e=il().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Wl=null;function Bl(e){return Wl=Wl||function(e){return new Promise(((t,n)=>{var i,r,o;function s(){zl(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{zl(),n(ks(e,"network-request-failed"))},timeout:Fl.get()})}if(null===(r=null===(i=il().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=il().gapi)||void 0===o?void 0:o.load)){const t=pl("iframefcb");return il()[t]=()=>{gapi.load?s():n(ks(e,"network-request-failed"))},dl(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Wl=null,e}))}(e),Wl}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function Jl(e=nt()){const t=Ze(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=Ze(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(oe(n.getOptions(),null!=t?t:{}))return e;xs(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Kl,persistence:[hl,Qa,Za]})}function Zl(){N.txtEmailLogin.value="",N.txtPasswordLogin.value="",N.txtEmailRegister.value="",N.txtPasswordRegister.value=""}function ec(){N.formLogin.style.display="flex",window.addEventListener("keydown",tc)}function tc(e){"Escape"===e.key&&(nc(),ic(),lc(),window.removeEventListener("keydown",tc))}function nc(){N.formLogin.style.display="none"}function ic(){N.signInContainer.style.display="none"}function rc(e){N.divLoginError1.style.display="block",N.lblLoginErrorMessage1.innerHTML=`Error: ${e.message}`}Yl="Browser",Je(new _e("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=n.options;return((e,n)=>{Ns(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Ns(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:o,clientPlatform:Yl,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:_a(Yl)},s=new ba(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Rs);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(s,t),s})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Je(new _e("auth-internal",(e=>{const t=wa(e.getProvider("auth").getImmediate());return new Ql(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),it("@firebase/auth","0.20.2",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Yl)),it("@firebase/auth","0.20.2","esm2017"),N.signUpBtn.addEventListener("click",(function(){ec(),ic(),yc(),N.signUpContainer.style.display="flex"})),N.signUpButtonClose.addEventListener("click",(()=>{nc(),lc()}));const oc=window.location.hash.substring(1);function sc(){N.divLoginError2.style.display="none",N.lblLoginErrorMessage2.innerHTML=""}function ac(e){N.divLoginError2.style.display="block","auth/wrong-password"==e.code?N.lblLoginErrorMessage2.innerHTML="ua"===oc?"Невірний пароль. Спробуйте ще раз.":"Wrong password. Try again.":N.lblLoginErrorMessage2.innerHTML="ua"===oc?`Помилка: ${e.message}`:`Error: ${e.message}`}function lc(){N.signUpContainer.style.display="none"}function cc(){ec(),lc(),yc(),N.signInContainer.style.display="flex"}N.signInBtn.addEventListener("click",cc),N.signInLogin.addEventListener("click",cc),N.signInButtonClose.addEventListener("click",(()=>{nc(),ic(),gc()}));const uc=window.location.hash.substring(1),hc=function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw et.create("bad-app-name",{appName:String(i)});const r=Ke.get(i);if(r){if(oe(e,r.options)&&oe(n,r.config))return r;throw et.create("duplicate-app",{appName:i})}const o=new be(i);for(const e of Ye.values())o.addComponent(e);const s=new tt(e,n,o);return Ke.set(i,s),s}({apiKey:"AIzaSyDcQX36y9qDVvGT9ex-Dyg3NuMiItVzDWw",authDomain:"filmoteka-goit-6e05f.firebaseapp.com",databaseURL:"https://filmoteka-goit-6e05f-default-rtdb.firebaseio.com",projectId:"filmoteka-goit-6e05f",storageBucket:"filmoteka-goit-6e05f.appspot.com",messagingSenderId:"281727023613",appId:"1:281727023613:web:ae072f932b4bc661d88194"}),dc=Jl(hc);async function pc(e,t){try{await Xa(dc,e,t),Zl(),nc()}catch(e){console.log(`There was an error: ${e}`),rc(e),Zl()}}async function mc(e,t){try{await Ga(dc,e,t),Zl(),sc(),nc()}catch(e){console.log(e),ac(e),Zl()}}async function fc(){try{await(e=dc,ye(e).signOut()),N.overlayBackdrop.style.display="flex"}catch(e){console.log(e)}var e}async function gc(){var e,t,n;e=e=>{e?(sc(),N.boxLoginLogout.style.display="flex",N.loginUser.innerHTML=`${e.email} `,N.btnLogout.removeEventListener("click",ec),N.btnLogout.addEventListener("click",fc),N.btnLogout.innerHTML="ua"===uc?"Вийти":"Log out",N.loginContainer.classList.add("is-hidden")):(N.loginContainer.classList.remove("is-hidden"),N.boxLoginLogout.style.display="none",N.btnLogout.removeEventListener("click",fc),N.btnLogout.addEventListener("click",ec))},ye(dc).onAuthStateChanged(e,t,n)}function yc(){N.overlayBackdrop.style.display="none",wu()}gc(),N.registerFormSignUp.addEventListener("submit",(e=>{e.preventDefault();pc(e.target.email.value.trim(),e.target.password.value.trim())})),N.registerFormSignIn.addEventListener("submit",(e=>{e.preventDefault();mc(e.target.email.value.trim(),e.target.password.value.trim())})),N.overlayBtnClose.addEventListener("click",yc),N.overlayBtn.addEventListener("click",cc),N.btnLogout.addEventListener("click",fc);const _c=function(e=nt(),t){return Ze(e,"database").getImmediate({identifier:t})}(hc),vc=Jl(hc);function bc(){var e;return null===(e=vc.currentUser)||void 0===e?void 0:e.uid}function wc(e,t,n){return hs(as(_c,`users/${n}/${e}${t}`)).then((e=>e.exists()))}function xc(e,t){const n=e.target.dataset.movie,i=Number(e.target.dataset.id);switch(e.target.id){case"add-to-watched":us(as(_c,`users/${t}/watchedMovies/${i}`),n),ru(e.target);break;case"add-to-queue":us(as(_c,`users/${t}/queueOfMovies/${i}`),n),ru(e.target);break;case"remove-from-watched":if(cs(as(_c,`users/${t}/watchedMovies/${i}`)),ru(e.target),!N.showLibraryBtn.classList.contains(Hc))return;ou(Jc);break;case"remove-from-queue":if(cs(as(_c,`users/${t}/queueOfMovies/${i}`)),ru(e.target),!N.showLibraryBtn.classList.contains(Hc))return;ou(Zc)}}function kc(e){const t=bc();return hs(ls(as(_c),`users/${t}/${e}`)).then((e=>{if(e.exists()){return e.val()}return N.filmsContainer.innerHTML="",void Vc()}))}const Cc=new d,Ic=new h,Nc=window.location.hash.substring(1),Tc={ul:document.getElementById("pagination_list"),filmsContainer:document.querySelector(".films__container")};let Ec=1;function Sc(e,t=1){let n="";if(t>1&&(n+='<li><button class="arrow" type=\'button\' data-page="previous">&#8592;</button></li>'),window.innerWidth<=768)if(e<=5)for(let i=1;i<=e;i+=1)n+=i===t?`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`;else for(let i=1;i<=e;i+=1)i===t?n+=`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:i>t+2||i<t-2?(i<6&&t<3&&(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`),i>e-5&&t>e-2&&(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`)):n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`;else if(e<=7)for(let i=1;i<=e;i+=1)n+=i===t?`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`;else for(let i=1;i<=e;i+=1)i===t?n+=`<li><button class="numbers active" type='button' data-page="${i}">${i}</button></li>`:1===i?t<=3?n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`:(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`,n+=' <li><p class="points">&#8230;</p></li>'):i===e?(t>=e-3||(n+=' <li><p class="points">&#8230;</p></li>'),n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`):i>t+2||i<t-2||(n+=`<li><button class="numbers" type='button' data-page="${i}">${i}</button></li>`);t<e&&(n+='<li><button class="arrow" type=\'button\' data-page="next">&#8594;</button></li>'),Tc.ul.innerHTML=n}async function Rc(t){if(C(),Tc.filmsContainer.innerHTML="","search"===su){if(Ic.query=au,Ic.setPage(t),""===Ic.query)return"ua"===Nc?e(w).Notify.info("Введіть, будь ласка, дані пошуку.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Please enter search data.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});const n=u();Ic.searchFilm(n).then((n=>{const i=n.results;if(Sc(n.total_pages,t),0===i.length)return"ua"===Nc?e(w).Notify.info("На жаль, немає фільмів, які відповідають вашому пошуковому запиту. Будь ласка, спробуйте ще раз.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Sorry, there are no movies matching your search query. Please try again.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});{const e=f(n);Tc.filmsContainer.insertAdjacentHTML("afterbegin",e)}})).catch((e=>console.log(e)))}else{Cc.setPage(t);try{const e=await Cc.fetchFilmsCards();Sc(e.total_pages,t);const n=f(e);Tc.filmsContainer.insertAdjacentHTML("afterbegin",n)}catch(e){console.log(e.message)}}I()}function Lc(e){if("button"===e.target.type){const t=e.currentTarget.id,n=e.target.dataset.page;"next"===n||"previous"===n||(Ec=Number(n)),Pc(Ec,t)}}async function Pc(e,t){switch(C(),t){case"library-pagination-watched":const t=await kc(Jc);if(!t)return;const n=Object.values(t);T(n.slice(20*e-20,20*e)),Sc(Math.ceil(n.length/20),e),I();break;case"library-pagination-queue":const i=await kc(Zc);if(!i)return;const r=Object.values(i);T(r.slice(20*e-20,20*e)),Sc(Math.ceil(r.length/20),e),I()}}Tc.ul.addEventListener("click",(function(e){if("button"===e.target.type){const t=e.target.dataset.page;"next"===t?(Ec+=1,Rc(Ec)):"previous"===t?(Ec-=1,Rc(Ec)):(Ec=Number(t),Rc(Ec))}}));const{showWatchedBtn:Ac,showQueueBtn:Oc,showLibraryBtn:Mc,showHomeBtn:Dc,libraryButtons:Fc,search:zc,header:Wc,emptyListMessage:Bc,paginationButtons:Uc,paginationContainer:qc}=N,jc=window.location.hash.substring(1),Hc="current-link";function $c(){Ac.classList.add("active"),Oc.classList.remove("active")}function Vc(){Bc.classList.remove("is-hidden"),qc.classList.add("is-hidden")}function Xc(){Bc.classList.add("is-hidden"),qc.classList.remove("is-hidden")}function Gc(){Uc.id="library-pagination-watched";document.getElementById("library-pagination-watched").addEventListener("click",Lc)}function Kc(){Uc.id="library-pagination-queue";document.getElementById("library-pagination-queue").addEventListener("click",Lc)}function Yc(e){Sc(Math.ceil(Object.values(e).length/20))}function Qc(){return"ua"===jc?w.Notify.warning("Увійдіть у свій акаунт, будь-ласка",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):w.Notify.warning("You should sign in first!",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1})}const Jc="watchedMovies/",Zc="queueOfMovies/";function eu(e){switch(C(),Xc(),e.target.id){case"watched":$c(),ou(Jc);break;case"queue":Oc.classList.add("active"),Ac.classList.remove("active"),ou(Zc)}I()}function tu(e){C();const t=bc();t?(xc(e,t),I()):Qc()}function nu(e){const{addToWatchedBtn:t,addToQueueBtn:n}=e;t.addEventListener("click",tu),n.addEventListener("click",tu)}async function iu(e,t){const{addToWatchedBtn:n,addToQueueBtn:i}=t,r=bc();n.setAttribute("data-movie",JSON.stringify(e)),i.setAttribute("data-movie",JSON.stringify(e)),n.setAttribute("data-id",e.id),i.setAttribute("data-id",e.id);await wc(Jc,e.id,r)&&function(e){e.id="remove-from-watched",e.textContent="ua"===jc?"Видалити з переглянутих":"Delete from watched"}(n);await wc(Zc,e.id,r)&&function(e){e.id="remove-from-queue",e.textContent="ua"===jc?"Видалити з обраних":"Delete from queue"}(i)}function ru(e){e.removeAttribute("data-movie"),e.removeAttribute("data-id")}async function ou(e){const t=await kc(e);if(!t)return;const n=function(e){return Object.values(e).length>20?Object.values(e).slice(0,20):Object.values(e)}(t);switch(Yc(t),T(n),e){case Jc:Gc();break;case Zc:Kc()}}let su,au;N.showWatchedBtn.addEventListener("click",eu),N.showQueueBtn.addEventListener("click",eu),N.showLibraryBtn.addEventListener("click",(function(){C();if(!bc())return void Qc();Gc(),Mc.classList.add(Hc),Dc.classList.remove(Hc),Fc.classList.remove("is-hidden"),zc.classList.add("is-hidden"),Wc.classList.add("header__background-library"),Wc.classList.remove("header__background"),$c(),ou(Jc),I()})),N.showHomeBtn.addEventListener("click",(function(){Xc(),Fc.classList.add("is-hidden"),zc.classList.remove("is-hidden"),Wc.classList.remove("header__background-library"),Wc.classList.add("header__background"),Uc.id="pagination_list"}));const lu=new h,cu=new d,uu=window.location.hash.substring(1),hu=document.querySelector(".films__container"),du=document.querySelector(".backdrop"),pu=document.querySelector(".modal_film-info"),mu=document.querySelector(".modal_film__button--close"),fu=document.querySelector(".search-form"),gu=document.getElementById("home"),yu=document.getElementById("library"),_u=document.querySelector(".logo"),vu=document.querySelector(".buttons"),bu=document.querySelector("[team-data-close]");async function wu(){fu[0].value="",Iu(),cu.resetPage(),gu.classList.add("current-link"),yu.classList.remove("current-link"),fu.classList.remove("is-hidden"),vu.classList.add("is-hidden"),C();try{const e=await cu.fetchFilmsCards();su="popular",Sc(e.total_pages);const t=f(e);hu.insertAdjacentHTML("afterbegin",t)}catch(e){console.log(e.message)}I()}function xu(){du.classList.add("is-hidden"),document.body.classList.toggle("modal-open"),du.removeEventListener("click",xu)}function ku(e){"Escape"===e.code&&(du.classList.add("is-hidden"),document.body.classList.toggle("modal-open"),document.removeEventListener("keydown",ku))}function Cu(){du.classList.add("is-hidden"),document.body.classList.toggle("modal-open"),du.removeEventListener("click",xu)}function Iu(){hu.innerHTML=""}document.addEventListener("DOMContentLoaded",wu),gu.addEventListener("click",wu),_u.addEventListener("click",(function(e){e.preventDefault(),wu()})),hu.addEventListener("click",(function(t){if(C(),t.preventDefault(),pu.innerHTML="",!t.target.dataset.id)return;{const n=u();_(t.target.dataset.id,n).then((t=>{if(!t)return"ua"===uu?e(w).Notify.info("Ваш запит не знайдено.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("The resource you requested could not be found.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});{const e=y(t);du.classList.remove("is-hidden"),document.body.classList.toggle("modal-open"),mu.addEventListener("click",Cu),du.addEventListener("click",xu),document.addEventListener("keydown",ku),pu.insertAdjacentHTML("beforeend",e),c();const n={addToWatchedBtn:document.getElementById("add-to-watched"),addToQueueBtn:document.getElementById("add-to-queue")};nu(n),iu(t,n)}})).catch((e=>console.log(e)))}I()})),fu.addEventListener("submit",(function(t){if(t.preventDefault(),au=t.currentTarget.elements.searchQuery.value.trim(),lu.query=t.currentTarget.elements.searchQuery.value.trim(),""===lu.query)return"ua"===uu?e(w).Notify.info("Введіть, будь ласка, дані пошуку.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Please enter search data.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});C(),lu.resetPage();const n=u();lu.searchFilm(n).then((t=>{if(0===t.results.length)return"ua"===uu?e(w).Notify.info("На жаль, немає фільмів, які відповідають вашому пошуковому запиту. Будь ласка, спробуйте ще раз.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1}):e(w).Notify.info("Sorry, there are no movies matching your search query. Please try again.",{timeout:3e3,opacity:.9,width:"150px",clickToClose:!0,pauseOnHover:!1});{Iu();const e=f(t);hu.insertAdjacentHTML("afterbegin",e)}su="search",Sc(t.total_pages)})).catch((e=>console.log(e))),I()})),bu.addEventListener("click",l),(()=>{const e={openModalBtn:document.querySelector("[team-data-modal]"),closeModalBtn:document.querySelector("[team-data-close]"),modal:document.querySelector("[team-data]")};function t(){e.modal.classList.toggle("is-hidden")}e.openModalBtn.addEventListener("click",t),e.closeModalBtn.addEventListener("click",t)})();const Nu=document.getElementById("change-theme-btn");function Tu(){document.body.classList.add("dark"),Nu.textContent="🌞",localStorage.setItem("theme","dark")}Nu.addEventListener("click",(()=>{document.body.classList.contains("dark")?(document.body.classList.remove("dark"),Nu.textContent="🌙",localStorage.setItem("theme","light")):Tu()})),"dark"===localStorage.getItem("theme")&&Tu();const Eu=document.getElementById("scroll-top");window.onscroll=function(){document.body.scrollTop>700||document.documentElement.scrollTop>700?Eu.classList.remove("scroll-top_show"):Eu.classList.add("scroll-top_show")},Eu.onclick=()=>{window.scrollTo(0,0)};
//# sourceMappingURL=index.42a78d63.js.map
